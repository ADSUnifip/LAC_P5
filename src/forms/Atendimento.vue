      ...
      <form id="formulario_paciente" ref="form">
        ...
        <div class="row">
          ...
          <div class=" input-group col-md-8 col-sm-12">
            ...
            <button id="open_modal" type="button" class="btn" @click="Modal()"><img src="../assets/adicionar.png"
                title="Adicionar Médico no Sistema" style="width:25px">
            </button>
          </div>
        </div>
        ...
        <div id="adicionar_procedimento" class="col">
          ...
          <div class=" input-group col-md-8 col-sm-12">
            ...
            <span class="input-group-addon">
              ...
              <button @click="AdicionarListPC()" class="btn"><img src="../assets/adicionar.png"
                  style="width:25px"></button>
            </span>
          </div>
        </div>
        ...
        <div id="listaflutuante" style="margin-top: 10px;">
          <ul class="list-group" v-if="ListSugestoes.length">
            <li class="list-group-item" v-for="sugestoes in ListSugestoes" :key="sugestoes.id"
              @click="selecionar(sugestoes)">
        ...
        <div id="resultado" v-for="item in ListProcedimentoSave" :key="item.id" class="col">
          <div id="procedimento" class="row itens">
            ...
            <div class="icon col-md-2 col-sm-12">
              <button @click="remover(ListProcedimentoSave.indexOf(item))" class="btn btn-danger"><img
                  src="../assets/lixeira.png" style="width:25px"></button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    async NovoAtendimento() {
      ...
      //Enviando
      const response = await request.post('/atendimento', formdata).then(({ data }) => {
